...
class Lista:
    ...
    def elemento(self, posicao):
        ...
        try:
            ...
            raise PosicaoInvalidaException(
                f'Posicao {posicao} invalida para a Lista')
        except TypeError:
            raise PosicaoInvalidaException(
                'O tipo de dado para posicao não é um número inteiro')
        except AssertionError:
            raise PosicaoInvalidaException(
                'A posicao não pode ser um número negativo')
        except:
            raise
    ...
    def busca(self, valor):
        ...
        try:
            ...
            raise ValorInexistenteException(
                f'O valor {valor} não está armazenado na lista')
        except:
            raise
    ...
    def inserir(self, posicao, valor):
        ...
        try:
            ...
            raise PosicaoInvalidaException(
                f'O tipo de dado para posicao não é um número inteiro')
        except AssertionError:
            raise PosicaoInvalidaException(
                f'A posicao não pode ser um número negativo')
        except:
            raise
    ...
    def remover(self, posicao):
        ...
        try:
            ...
            if (len(self.__dado) == 0):
                raise PosicaoInvalidaException(
                    f'A lista está vazia! Não é possivel remover elementos')
            valor = self.__dado[posicao-1]
            del self.__dado[posicao-1]
            return valor
        except IndexError:
            raise PosicaoInvalidaException(
                f'Posicao {posicao} invalida para remoção')
        except TypeError:
            raise PosicaoInvalidaException(
                f'O tipo de dado para posicao não é um número inteiro')
        except AssertionError:
